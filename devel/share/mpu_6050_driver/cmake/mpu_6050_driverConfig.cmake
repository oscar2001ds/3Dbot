...
if("TRUE" STREQUAL "TRUE")
  set(mpu_6050_driver_SOURCE_PREFIX /home/oscar/3drobot/src/mpu_6050_imu)
  set(mpu_6050_driver_DEVEL_PREFIX /home/oscar/3drobot/devel)
  ...
  set(mpu_6050_driver_INSTALL_PREFIX /home/oscar/3drobot/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mpu_6050_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/oscar/3drobot/src/mpu_6050_imu/${idir}'.  ${_report}")
    endif()
