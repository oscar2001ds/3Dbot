...
echo_and_run cd "/home/oscar/3drobot/src/mpu_6050_driver"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/oscar/3drobot/src/mpu_6050_driver/setup.py" \
     \
    build --build-base "/home/oscar/3drobot/build/mpu_6050_driver" \
    install \
    --root="${DESTDIR-/}" \
